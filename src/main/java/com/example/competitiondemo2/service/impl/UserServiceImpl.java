...
public class UserServiceImpl implements UserService {
    ...
    @Override
    public User selectByPhoneAndPwd(String username,String pwd) {
        return userMapper.selectByPhoneAndPwd(username,pwd);
    }


    @Override
    public Result loginCheck(String phonenum, String password, HttpServletResponse response) {
        User user1 = userMapper.selectByPhoneAndPwd(phonenum,password) ;
    ...
    @Override
    public Result register(String username, String password, String phonenum) {
        ...
        userMapper.register(username,password,phonenum);
